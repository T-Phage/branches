(function () {
    ...
    if (!sessionStorage.getItem('user')) {
        ...
        document.getElementById('logBtn').innerHTML = '<button type="button" class="nav-link btn btn-primary logBtnClass">Check an order</button>';
        ...
        function tester() {
            ...
            document.getElementById('logBtn').innerHTML = '<button type="button" class="nav-link btn btn-primary logBtnClass">Your Orders</button>';
