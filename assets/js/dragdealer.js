...
/* Edited by solar: 3dtranslate instead of translateX and translateY, removed perspective and backface-visibility hidden*/
...
(function(root, factory) {
    ...
    var Dragdealer = function(wrapper, options) {
        ...
        //document.getElementById('proTh').style.visibility = 'hidden';
        //document.getElementById('proThSedan').style.visibility = 'hidden';
        //document.getElementById('proTd').remove();
        this.bindMethods();
